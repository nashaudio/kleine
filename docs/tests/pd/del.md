...
clock-unit rules in `m_sched.c`. Revisions and hashes are in [sources.json](../../../tests/pd/sources.json);
...
[52 cases](../../../tests/pd/del-results.json), 26 each at 48 and 44.1 kHz, compare the actual class
with the isolated [PD fixture](../../../tests/pd/del.pd): construction, idle, hot/cold floats, bang,
