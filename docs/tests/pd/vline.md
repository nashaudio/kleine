...
[Source hashes](../../../tests/pd/sources.json) identify the inspected revision.
...
Create `build/vline-review` first. The [PD fixture](../../../tests/pd/vline.pd) and
[C++ driver](../../../tests/pd/vline.cpp) cover floats/lists, cold-inlet consumption, ordered queues,
...
[Results](../../../tests/pd/vline-results.json) record 25 cases at each of 48 and 44.1 kHz using
...
[model report](../../../tests/pd/vline-model-results.json) compares the established recipes against
