...
44.1 kHz, 64-sample PD blocks. [Results](../../../tests/pd/dtmf-message-results.json) retain commands,
...
[env output checks](../../../tests/pd/env-output-results.json) compare raw output and event frames
...
The isolated [Sand fixture](../../../tests/pd/sand-messages.pd) sends fourteen messages covering
...
[18 paired renders](../../../tests/pd/dtmf-model-results.json) cover the dialler, unfiltered study,
...
`build/env-publication/models`. Its [18 before/after renders](../../../tests/pd/env-model-results.json)
