...
and `build/artificial/`; [raw results](../../../../farnell/audio/comparisons/phone-tones-review.json)
...
[raw fits](../../../../farnell/audio/comparisons/reference-levels.json) retain the evidence.
...
[Raw event traces](../../../../farnell/audio/comparisons/phone-timing.json) and
