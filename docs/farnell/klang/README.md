...
undergone a [PD topology review](../reviews/KLANG-TOPOLOGY-REVIEW.md). The current code
...
evidence. [Current raw comparisons](../../../farnell/audio/comparisons/klang-topology-review.json)
...
separable from the pure model. See [PD-BLOCK.md](../reviews/PD-BLOCK.md).
...
[style-only comparison](../../../farnell/audio/comparisons/klang-style-review.json) remains
