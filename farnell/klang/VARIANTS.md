...
The comparison renderer includes [variants.h](../variants.h) and retains the old
...
| `dtmf-study` | [DTMFUnfiltered](Artificial%20Sounds/DTMF%20Tones/variants/dtmf-unfiltered.k) | ALARMS dtmf00, no highpass, gain 0.125. |
| `police` | `Police` | Current website pow~ convention. |
| `police-legacy` | [PoliceExponential](Artificial%20Sounds/Police/variants/police-exponential.k) | Historical reversed pow~ operands. |
| `police-*` components | [Oscillator studies](Artificial%20Sounds/Police/variants/oscillators.k) | Explicit power/exponential/triangle flows; component selection is in the renderer. |
| `bouncing` | `Bouncing` | Website fourth-power pitch shape. |
| `bouncing-bulk` | [BouncingExponential](Idiophonics/Bouncing/variants/bouncing-exponential.k) | BOUNCINGBALL bb1, modern operands: exp(envelope). |
| `bouncing-legacy` | [BouncingPower](Idiophonics/Bouncing/variants/bouncing-power.k) | bb1 reversed operands: envelope raised to e; negative-base guard matches PD. |
| `boing` | `Boing` | Website env16p actually raises to 64. |
| `boing-bulk` | [BoingExponential](Idiophonics/Boing/variants/boing-exponential.k) | MRBOINGY twang, modern operands: 15 raised to envelope. |
| `boing-legacy` | [BoingPower](Idiophonics/Boing/variants/boing-power.k) | MRBOINGY twang, reversed operands: envelope raised to 15. |
...
[raw comparison report](../audio/comparisons/model-variants-review.json) compares
